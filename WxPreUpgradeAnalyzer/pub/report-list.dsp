						...
						<table class="tableView" cellpadding="2"> 
							<tbody>
								<tr>
									...
									%loop fileList%
									<tr>
										<td class="oddcol"><input type="checkbox" name="files" value="%value fileList%" onclick="checkButton();"></td><td class="evencol-l"><a href="reports/%value fileList%" download="reports/%value fileList%" class="td">%value fileList%</a></td>
									</tr>
									%endloop%
									<tr>
