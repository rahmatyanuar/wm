        ...
        <TR>
            <TD colspan="3">
                <UL class="listitems">
                    <LI>
                        ...
                        <script>
                            getURL("integration-live-metadata-share.dsp","javascript:document.htmlform_integration_live_metadata_share.submit();","Return to webMethods Cloud Applications");
                        </script>
                    </LI>
                </UL>
            </TD>
            ...
            <TD width="70%">
                ...
                <TABLE WIDTH="100%" class="tableView">
                    ...
                    %endinvoke%
                    <input type="hidden" name="restrictedChars" id="restrictedChars"
                           value="%value encode(htmlattr) restrictedChars%"/>
                    <TR>
                        <TD class="oddrow" nowrap><label for="applicationName">Name</label></TD>
                        <TD class="oddrow-l">
                            <INPUT NAME="applicationName" id="applicationName" TYPE="TEXT"
                                   VALUE="%value encode(htmlattr) applicationName%" SIZE="50" readonly="true"
                                   style="color:#808080;"/>
                        </TD>
                    </TR>
                    <TR>
                        ...
                        <TD class="evenrow-l">
                            <INPUT NAME="description" id="description" TYPE="TEXT"
                                   VALUE="%value encode(htmlattr) description%" SIZE="85"/>
                        </TD>
                    </TR>
                    <TR>
                                ...
                                <TR title="%value name%">
                                    <TD colspan="2">
                                        <a onclick="toggle(this,'%value encode(javascript) name%');">
                                            <img id="img%value name%" class="imgStyle" src="images/plus.gif"/><label
                                                class=".label"> &nbsp;%value encode(htmlall) name% </label>
