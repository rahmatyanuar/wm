...
// -----( CREATED: 2012-10-11 12:21:27 MYT
// -----( ON-HOST: maxis71
...

{
	...
	Enumeration _enum = vecUnzippedFileNames.elements();
	int i = 0;
	while (_enum.hasMoreElements())
	{
		arrStrUnzippedFileNames[i] = (String)_enum.nextElement();
		i++;
	}
	...
	public static final void zipByOSCommand (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(zipByOSCommand)>> ---
		// @sigtype java 3.5
		// [i] field:0:required zipFileName
	...
	{
		// prepare Zip Command
		strCommand = "zip -9 "+zipFileName+" "+fileName;
