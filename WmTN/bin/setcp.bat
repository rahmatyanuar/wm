...
rem ================================================================
rem Update CLASSPATH to include all log4j jar and zip files in lib\ext\log4j
rem of the B2B server
rem ================================================================
if exist "%WEBMEXT%\log4j" (
    call :appendJarsAndZips "%WEBMEXT%\log4j"
)
