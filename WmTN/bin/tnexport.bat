...
SET SCMD="%JDKDIR%\bin\%SUNCMD%" -ms64M -mx64M -classpath %CLASSPATH% com.wm.app.tn.data.Export "%INSTANCEDIR%" %1 %2 %3 %4 %5 %6 %7 %8 %9
goto launch

:jview
SET SCMD=jview /cp %CLASSPATH% com.wm.app.tn.data.Export "%INSTANCEDIR%" %1 %2 %3 %4 %5 %6 %7 %8 %9
goto launch
