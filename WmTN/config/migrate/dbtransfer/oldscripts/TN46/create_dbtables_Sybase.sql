...
CREATE TABLE BizDocArchive (
       DocID                char(24) NOT NULL,
       ArchiveTimestamp     datetime DEFAULT GETDATE() NOT NULL,
       DocTimestamp         datetime NOT NULL,
...
CREATE TABLE DeliveryService (
       ...
       B2BInterface         text NOT NULL,
       B2BService           text NOT NULL,
...
CREATE TABLE DeliveryJob (
       ...
       TransportStatusMessage text NULL,
...
CREATE TABLE Process(
	...
	ParentInstanceID	varchar(128) NULL,
	ProcessKey			varchar(64) NOT NULL,
	ProcessLabel		text NULL,
	ProcessVersion		varchar(64) NULL,
	Status				varchar(40) NOT NULL,
  DeploymentVersion integer NULL,  
...
CREATE TABLE ProcessStep(
	...
	StepLabel			varchar(128) NULL,
	Status				varchar(40) NOT NULL,
	System				varchar(10) NOT NULL,
	CurrentTry			integer NOT NULL,
  TargetStepIDs   varchar(255) NULL,
...
CREATE TABLE TNProcess(
	...
	UserInstanceID		varchar(150) NULL,
	UserInstanceID2	varchar(150) NULL,
...
CREATE TABLE ActivityLog(
       ...
       RelatedInstanceID	 varchar(128) NULL,
       RelatedStepID			 varchar(128) NULL,
...
CREATE TABLE ProcessDefinition (
	ProcessKey		varchar(64) NOT NULL,
	ProcessLabel		varchar(255) NULL,
	OID			varchar(128) NULL,
...
CREATE TABLE StepDefinition(
	...
	Icon			image NULL,
	Description		text NULL,
	IS_Start		integer NULL,
	IS_Stop			integer NULL,
	Icon_X			integer NULL,
	Icon_Y			integer NULL,
	...
	Server			varchar(128) NULL,
	Component		varchar(128) NULL,
	SubprocessKey		varchar(64) NULL,
	InlineStepID		varchar(128) NULL
)
go
...
CREATE TABLE StepTransitionDefinition(
	...
	SourceX			integer NULL,
	SourceY			integer NULL,
	TargetX			integer NULL,
	TargetY			integer NULL,
	VisualType		varchar(10) NULL,
...
CREATE TABLE SchemaDefinition (
	...
	CreatingSystem		varchar(20) NULL
)
go
