   ...
   <TR>
    ...
    %ifvar action%
      ...
      <tr><td colspan="2">&nbsp;</td></tr>
          ...
          %endinvoke%
        %case 'addAllowListService'%
          %invoke wm.server.net:ipHostListServiceAdd%
          <tr><td colspan="2">&nbsp;</td></tr>
            <TR><TD class="message" colspan=2>%value message encode(html)%</TD></TR>
               <TR>
                 <TD colspan="2">&nbsp;</TD>
        ...
        %case 'addDenyListService'%
          ...
          %endinvoke%
        %case 'onDemandInvokeService'%
          %invoke wm.server.netimpl:runOnDemandHostListService%
          %value hostNames%
          <tr><td colspan="2">&nbsp;</td></tr>
                <TR><TD class="message" colspan=2>%value message encode(html)%</TD></TR>
                  <TR>
    ...
    <TR>
      <TD colspan="2">
		...
		createForm("htmlform_security_ports", "security-ports.dsp", "POST", "BODY");
		  ...
		  createForm("htmlform_server_ipaccess_host_allow_list_service", "server-ipaccess.dsp", "POST", "BODY");
          setFormProperty("htmlform_server_ipaccess_host_allow_list_service", "action", "addAllowListService");
          setFormProperty("htmlform_server_ipaccess_host_allow_list_service", "listenerKey", "%value listenerKey %");
          setFormProperty("htmlform_server_ipaccess_host_allow_list_service", "pkg", "%value pkg %");
          setFormProperty("htmlform_server_ipaccess_host_allow_list_service", "allowListService", "%value allowListService %");
          setFormProperty("htmlform_server_ipaccess_host_allow_list_service", "allowListServiceInterval", "%value allowListServiceInterval %");

          createForm("htmlform_server_ipaccess_host_deny_list_service", "server-ipaccess.dsp", "POST", "BODY");
          setFormProperty("htmlform_server_ipaccess_host_deny_list_service", "action", "addDenyListService");
          setFormProperty("htmlform_server_ipaccess_host_deny_list_service", "listenerKey", "%value listenerKey %");
          setFormProperty("htmlform_server_ipaccess_host_deny_list_service", "pkg", "%value pkg %");
          setFormProperty("htmlform_server_ipaccess_host_deny_list_service", "denyListService", "%value denyListService %");
          setFormProperty("htmlform_server_ipaccess_host_deny_list_service", "denyListServiceInterval", "%value denyListServiceInterval %");
          ...
          %switch type%
            ...
            %endswitch%
              ...
              %ifvar listenerKey equals('global')%
                <li>
                    <script>getURL("server-ipaccess.dsp?listenerKey=global&action=onDemandInvokeService", "", "Refresh IP Access List");</script>
                </li>
              %else%
              <li>
                <script>getURL("server-ipaccess.dsp?listenerKey=%value listenerKey encode(url)%&pkg=%value pkg encode(url)%&action=onDemandInvokeService", "", "Refresh IP Access List");</script>
              </li>
              %endif%
            </UL>
         </TD>
    ...
    <TR>
      ...
      %ifvar listenerKey equals('global')%
          %invoke wm.server.query:getGlobalIPAccessServiceNameAndInterval%
            %switch type%
              %case 'include'%
                %ifvar hostDenyListService%
                  <table class="tableView">
                      <TR>
                        <TD class="heading" colspan="2">Service Name and Interval &emsp;</TD>
                      </TR>
                      <tr>
                          <TD class="oddrow" valign="top"><label>Service</label></TD>
                          <td class="oddrow-l">
                            %value hostDenyListService%
                          </td>
                      </tr>
                      <tr>
                          <TD class="oddrow" valign="top"><label>Polling Interval</label></TD>
                          <td class="oddrow-l">
                            %value hostDenyListServiceIntervalInWords%
                          </td>
                      </tr>
                  </table>
                  <BR>
                ...
                %ifvar hostAllowListService%
                  <table class="tableView">
                    ...
                    <tr>
                        <TD class="oddrow" valign="top"><label>Service</label></TD>
                        <td class="oddrow-l">
                          %value hostAllowListService%
                        </td>
                    </tr>
                    <tr>
                        <TD class="oddrow" valign="top"><label>Polling Interval</label></TD>
                        <td class="oddrow-l">
                            %value hostAllowListServiceIntervalInWords%
                        </td>
                    </tr>
                  </table>
                  <BR>
