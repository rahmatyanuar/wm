...
app.controller("myCtrl", function ($scope, myserv) {
  ...
  $scope.addAuthorizedDetails = function(){
    ...
    if(document.getElementById("buildnumber")==null&!($scope.package.buildNumber==undefined||$scope.package.buildNumber==null))
    ...
    if(document.getElementById("createddate")==null&!($scope.package.createdDate==undefined||$scope.package.createdDate==null))
    ...
    if(document.getElementById("status")==null&&$scope.package.status!=undefined&&$scope.package.status!=null&&$scope.package.status!='')
    ...
    if(document.getElementById("tags")==null&&$scope.package.tags!=undefined&&$scope.package.tags!=null){
      var div = document.createElement('div');
      div.classList.add('row', 'mt-2', 'pb-2');
      div.style.width = '100%';
      div.style.float = 'right';
      div.id = 'tags';
      var div1 = document.createElement('div')
      div1.classList.add('col-sm-12','pl-0');
      for(var i=0;i< $scope.package.tags.length;i++){
        var span = document.createElement('span');
        span.classList.add('badge','badge-secondary','mr-1');
        span.innerHTML = $scope.package.tags[i];
        div1.appendChild(span);
      }
      
      div.appendChild(div1);
      document.getElementById("detailstable").insertAdjacentElement("afterend",div)
    }
    var apiList = document.getElementById("apis").getElementsByTagName("li");
    ...
    var servicesList = document.getElementById("services").getElementsByTagName("li");
  ...
  $scope.initWindow = function(){
    ...
    if ($(window).width() < 999) {
      console.log(document.getElementById("explore-content"))
