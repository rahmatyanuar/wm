    ...
    <tr>
      <td>
		...
		<table class="tableView">
          ...
          <tr>
            <td class="heading" colspan=5 nowrap>Streaming Configuration</td>
          </tr>
          <TR>
            <TD colspan="2" nowrap>
              <ul class="listitems">
                ...
                <li class="listitem">
				          <script>getURL("streaming.dsp","javascript:document.htmlform_settings_streaming.submit();","Streaming Settings")</script>
                </li>
                <li class="listitem">
				          <script>getURL("streaming-trigger-management.dsp","javascript:document.htmlform_settings_streaming_trigger_management.submit();","Streaming Trigger Management")</script>
                </li>
              </ul>
            </td>
          </tr>
