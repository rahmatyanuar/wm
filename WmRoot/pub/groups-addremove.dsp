    ...
    <tr>
          ...
          <tr>
            ...
            %switch name%
              ...
              %case 'ReadOnlyAdministrators'%-</td><td>ReadOnlyAdministrators (not removable)
              ...
              %case% <input type="checkbox" id="%value name encode(htmlattr)%" name="%value name encode(htmlattr)%" value="REMOVE"></td><td><label for="%value name encode(htmlattr)%">%value name encode(html)%</label>
            %endswitch%
          </td>
          </tr>
