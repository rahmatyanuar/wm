            ...
            <table width="100%" class="tableView">  
              ...
              <tr>
                ...
                <td class="subheading2" nowrap>
                  State&nbsp;&nbsp;
                  <script>
                    createForm("htmlform_mqtt_edit_state", "mqtt-edit-state.dsp", "POST", "BODY");
                    setFormProperty("htmlform_mqtt_edit_state", "triggerName", "all");
                  </script>
                  %ifvar webMethods-wM-AdminUI%
                    <script>
                      getURL("mqtt-edit-state.dsp?triggerName=all&webMethods-wM-AdminUI=true", "javascript:document.htmlform_mqtt_edit_state.submit();", "edit&nbsp;all");
                    </script>
                  %else%
                    <script>
                      getURL("mqtt-edit-state.dsp?triggerName=all", "javascript:document.htmlform_mqtt_edit_state.submit();", "edit&nbsp;all");
                    </script>
                  %endif%
                </td>
