...
%invoke wm.deployer.gui.UIRepository:listComponentsInComposite%
  ...
  var compositeTree = new WebFXCheckBoxTreeItem("%value assetCompositeDisplayName%", null, false, null, 
	...
	var matchCnt = 0;
  %loop components%  	
      var componentNode = new WebFXCheckBoxTreeItem("%value -htmlcode componentDisplayName%", null, 
